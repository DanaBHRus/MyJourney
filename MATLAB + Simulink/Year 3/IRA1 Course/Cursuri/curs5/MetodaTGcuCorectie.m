...
Hr = 1/Hf * Ho/(1-Ho);
zpk(Hr)
Hr_simplificat = tf(7.0389*[0.3125,1],[0.3125/100,1]);
...
% Hr_simplificat = tf(7.0389*[0.3125,1],[0.2289,1]); - to keep 
% Hr_simplificat = tf(7.0389*[0.3125,1],[0.3125/100,1]); - daca se introduce
%   un PD real