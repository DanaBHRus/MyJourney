...
%%ordinul subsistem intrare - viteza
n4sid(data_id_wu,1:10);

%discret
m_n4sid_wu = n4sid(data_id_wu,1);
figure(),resid(m_n4sid_wu,data_vd_wu);
figure(),compare(m_n4sid_wu,data_vd_wu);

%discret, cu datele decimate
m_n4sid_wu_dec = n4sid(data_id_wu_dec,1);
figure(),resid(m_n4sid_wu_dec,data_vd_wu_dec);
figure(),compare(m_n4sid_wu_dec,data_vd_wu_dec);
