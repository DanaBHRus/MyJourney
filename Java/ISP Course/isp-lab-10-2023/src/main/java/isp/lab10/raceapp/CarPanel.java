...
class CarPanel extends JPanel {
    ...
    public void carFinished(String carName, Duration duration) {
        System.out.println(carName + " finished race at position " + position + " in " + duration.toMillis() + " miliseconds.");
        position++;
    }
