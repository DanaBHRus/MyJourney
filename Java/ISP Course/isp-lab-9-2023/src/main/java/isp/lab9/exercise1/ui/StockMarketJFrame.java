...
import isp.lab9.exercise1.services.UserPortofolioService;
...
public class StockMarketJFrame extends JFrame {
    ...
    private UserPortofolioService portfolioService;
    ...
    public StockMarketJFrame() {
        try {
            ...
            portfolioService = new UserPortofolioService(portfolio);
            portfolioService.refreshMarketData();
    ...
    public UserPortofolioService getPortofolioService() {return portfolioService;}
